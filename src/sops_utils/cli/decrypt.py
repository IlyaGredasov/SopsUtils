...
from sops_utils.core import decrypt_file, encrypt_file
...
def main() -> None:
    ...
    decrypt_file(args.source_file, args.output_file, args.age_key_file)
    if args.with_k8s:
        values, schema = load_env_values(args.output_file, args.env_schema_file)
